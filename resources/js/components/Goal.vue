<template>
    <div class="container-fluid h-100 pt-5">
        <i class="fa fa-plus pl-3" data-bs-toggle="modal" data-bs-target="#goalModal"></i><span class="align-middle"> Create A New Goal</span>
        <i class="fa fa-plus align-middle pl-4 pr-1" data-bs-toggle="modal" data-bs-target="#tagModal"></i><span class="align-middle">Manage Tag</span>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div v-for="(key, index) in tags" :key="index">
                            <button class="btn btn-secondary m-1" v-on:click="tagTitle = tags[index].title; tagId = tags[index].id" data-bs-toggle="modal" data-bs-target="#editTagModal" data-dismiss="modal">{{ tags[index].title }}</button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" data-bs-toggle="modal" data-bs-target="#tagModal" v-on:click="tagTitle = ''; tagId = ''">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" data-dismiss="modal" data-bs-toggle="modal" data-bs-target="#tagModal" v-on:click="tagTitle = ''; tagId = ''">Save changes</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div v-for="(goal, key, index) in goals" :key=index>
                <div class="card h-100 m-3" style="width: 24rem;">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <i class="fa fa-plus p-2" data-bs-toggle="modal" :data-bs-target="'#todoModal'+goal.id"></i>
                            <div class="btn-group dropdown">
                                <i class="fa fa-ellipsis-v p-2 dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <div class="text-center" data-bs-toggle="modal" data-bs-target="#editGoalModal" v-on:click="title = goal.title; id = goal.id">Edit</div>
                                    <div class="text-danger text-center" data-bs-toggle="modal" data-bs-target="#deleteGoalModal" v-on:click="id = goal.id">Delete</div>
                                </div>
                            </div>
                        </div>
                    </div>
