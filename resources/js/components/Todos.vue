                ...
                <div class="card" style="width: 18rem;" v-if="todo.done == 0">
                    ...
                    <div class="btn-group position-absolute dropdown" style="top:10px; right:4px;">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="text-center" data-bs-toggle="modal" :data-bs-target="'#todoModal'+goalId+todo.id" v-on:click="content = todo.content">Edit</div>
                            <div class="text-center" data-bs-toggle="modal" :data-bs-target="'#todoSortModal'+goalId+todo.id" v-on:click="content = todo.content">Sort</div>
